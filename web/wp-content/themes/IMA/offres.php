	...
	<div class="fond-ribbon"></div>
		...
		<?php query_posts( array ( 'post_type' => 'offres', 'posts_per_page' => -1 ) ); ?>
				...
				<div class="bloc-content small-padding-top">
					...
					?>
					<div class="nb-offres"><p><strong><?php echo $nbOffres . ' ' . $txt1; ?></strong> <?php echo $txt2; ?><br />N'hésitez pas à nous envoyer <a class="btn-bleu" href="<?php echo $current; ?>postuler?offre=none">votre candidature spontanée</a>.</p></div>
				</div>
			...
			<?php  while ( have_posts() ) : the_post(); ?>
				...
				<div class="bloc-full bloc-penche article">
					...
					<div class="bloc-content small-padding-top" id="bloc-actus">
						...
						<div class="date-categ-actu">Le <span class="date-actu"><?php echo get_the_date(); ?></span> - site de <?php the_field('offre_localisation'); ?> </div>
...
<section id="content-right">
	...
	<?php $pages = $pages = get_posts(array( 'post_type' => 'page', 'meta_key' => '_wp_page_template', 'meta_value' => 'postuler.php' )); 
			...
			<div id="bloc-interlocuteur">
				<span class="categ-bloc-interlocuteur">
					...
					<span class="container-photo-bloc-interlocuteur">
						<?php if( get_field('interlocuteur_img', $page->ID) ) { ?><span class="fond-photo-bloc-interlocuteur"><img src="<?php echo get_field('interlocuteur_img', $page->ID)['sizes']['thumbnail']; ?>" alt="<?php echo get_field('interlocuteur_img', $page->ID)['alt']; ?>"/></span><?php } ?>
					</span>
				...
				<span class="txt-bloc-deform-interlocuteur">
					<h3><?php the_field('interlocuteur_nom', $page->ID); ?></h3>
					<ul class="contact-bloc-interlocuteur">
						<?php if( get_field('interlocuteur_tel', $page->ID) ) { ?><li class="has-icon"><div class="icon-telephone"></div><?php the_field('interlocuteur_tel', $page->ID); ?></li><?php } ?>
						<?php if( get_field('interlocuteur_mail', $page->ID) ) { ?><li class="has-icon"><div class="icon-mail"></div><a href="mailto:<?php the_field('interlocuteur_mail'); ?>"><?php the_field('interlocuteur_mail', $page->ID); ?></a></li><?php } ?>
					</ul>
				</span>
						...
						<nav id="interlocuteur-modal">
							...
							<div id="content-interlocuteur">
								<div class="bloc-gauche-content-interlocuteur">
									<div class="container-photo-interlocuteur"><div class="fond-photo-interlocuteur"><?php if( get_field('interlocuteur_img', $page->ID) ) { ?><img src="<?php echo get_field('interlocuteur_img', $page->ID)['sizes']['thumbnail']; ?>" alt="<?php echo get_field('interlocuteur_img', $page->ID)['alt']; ?>"/><?php } ?></div></div>
								</div><div class="bloc-droite-content-interlocuteur">
									<h3><?php the_field('interlocuteur_nom', $page->ID); ?></h3>
									<?php if(get_field('interlocuteur_devise', $page->ID)) echo "<blockquote>". get_field('interlocuteur_devise', $page->ID) ."</blockquote>"; ?>
									<ul class="contact-interlocuteur">
										<?php if( get_field('interlocuteur_tel', $page->ID) ) { ?><li class="has-icon"><div class="icon-telephone"></div><?php the_field('interlocuteur_tel', $page->ID); ?></li><?php } ?>
										<?php if( get_field('interlocuteur_mail', $page->ID) ) { ?><li class="has-icon"><div class="icon-mail"></div><a href="mailto:<?php the_field('interlocuteur_mail', $page->ID); ?>"><?php the_field('interlocuteur_mail', $page->ID); ?></a></li><?php } ?>
										<li>
											<ul class="social-interlocuteur">
												<?php if( get_field('interlocuteur_twitter', $page->ID) ){ ?><li class="twitter"><a href="<?php the_field('interlocuteur_twitter', $page->ID); ?>" target="_blank"><span class="icon-twitter"></span></a></li><?php } ?>
												<?php if( get_field('interlocuteur_linkedin', $page->ID) ){ ?><li class="linkedin"><a href="<?php the_field('interlocuteur_linkedin', $page->ID); ?>" target="_blank"><span class="icon-linkedin"></span></a></li><?php } ?>
												<?php if( get_field('interlocuteur_fb', $page->ID) ){ ?><li class="facebook"><a href="<?php the_field('interlocuteur_fb', $page->ID); ?>" target="_blank"><span class="icon-facebook"></span></a></li><?php } ?>
												<?php if( get_field('interlocuteur_viadeo', $page->ID) ){ ?><li class="viadeo"><a href="<?php the_field('interlocuteur_viadeo', $page->ID); ?>" target="_blank"><span class="icon-viadeo"></span></a></li><?php } ?>
											</ul>
										</li>
									</ul>
								</div>
