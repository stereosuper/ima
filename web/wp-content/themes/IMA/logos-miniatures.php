<?php
/*
Template Name: Logos Miniatures
*/
							...
							<ul class="slider-logos">
								...
								<li>
									<div class="bloc-slider-logos">
										...
										<a href="<?php echo wp_get_attachment_image_src( $id, 'medium', true )[0]; ?>" class="telecharger-logo-bloc"> <span class="container-fond-telecharger-logo-bloc"> <span class="fond-telecharger-logo-bloc"></span> </span> <span class="txt-telecharger-logo-bloc">Copier le lien</span></a>
									</div>
								</li>
